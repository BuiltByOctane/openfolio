...
import { TEMPLATES, TEMPLATE_LABELS } from "@/shared/ui/templates";
import {
  samplePortfolio,
  githubOnlyFixture,
} from "@/feature/dev/utils/sample-portfolio";
import { TEMPLATE_IDS, type TemplateId } from "@/shared/types/portfolio";
...
export default function DevTemplatesPage({
  ...
  const fixture =
    searchParams?.fixture === "github" ? githubOnlyFixture : samplePortfolio;
